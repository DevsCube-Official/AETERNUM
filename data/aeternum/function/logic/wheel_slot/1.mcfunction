...
execute unless score @s aeternum.ability_wheel.maximum_slots matches 1.. run playsound minecraft:block.note_block.didgeridoo player @s ~ ~ ~
execute unless score @s aeternum.ability_wheel.maximum_slots matches 1.. run tellraw @p {"translate":"aeternum.power_wheel.fail_missing_slot.1"}
execute unless score @s aeternum.ability_wheel.maximum_slots matches 1.. run return run function pdb:save_me
...
$data modify storage pdb:main in.Aeternum.stats.wheel.abilities[0].function set value "$(function)"
