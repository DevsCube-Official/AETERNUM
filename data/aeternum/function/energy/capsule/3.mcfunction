give @p clock[item_model="aeternum:energy_capsule/3",item_name='{"translate":"aeternum.item.name.energy_capsule"}',consumable={animation:drink,has_consume_particles:false,consume_seconds:1f,sound:"minecraft:item.honey_bottle.drink"},lore=['{"translate":"aeternum.item.lore.energy_capsule","with":[{"text":"3","color":"green","italic":false}]}']]
scoreboard players add @s aeternum.energy.bar_type.base 4
...
function aeternum:leveling/randomizer/root {n:10}