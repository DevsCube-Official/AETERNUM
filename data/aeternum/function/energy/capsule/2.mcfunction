give @p clock[item_model="aeternum:energy_capsule/2",item_name='{"translate":"aeternum.item.name.energy_capsule"}',consumable={animation:drink,has_consume_particles:false,consume_seconds:1f,sound:"minecraft:item.honey_bottle.drink"},lore=['{"translate":"aeternum.item.lore.energy_capsule","with":[{"text":"2","color":"green","italic":false}]}']]
scoreboard players add @s aeternum.energy.bar_type.base 3
