give @p clock[item_model="aeternum:energy_capsule/4",item_name='{"translate":"aeternum.item.name.energy_capsule"}',consumable={animation:drink,has_consume_particles:false,consume_seconds:1f,sound:"minecraft:item.honey_bottle.drink"},lore=['{"translate":"aeternum.item.lore.energy_capsule","with":[{"text":"4","color":"green","italic":false}]}']]
scoreboard players add @s aeternum.energy.bar_type.base 5
...
function aeternum:leveling/randomizer/root {n:8}