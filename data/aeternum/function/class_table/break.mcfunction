...
execute align xyz positioned ~0.5 ~0.5 ~0.5 if entity @e[type=minecraft:marker,tag=aeternum.class_table.marker,distance=..0.01,limit=1] run kill @e[type=minecraft:marker,tag=aeternum.class_table.marker,distance=..0.01,limit=1]
