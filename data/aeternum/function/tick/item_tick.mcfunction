...
execute as @s[type=item,nbt={Item:{id:"minecraft:netherite_block",count:1}}] at @s if block ~ ~ ~ minecraft:lava on origin if score @s aeternum.player.quest_id matches 42 run function aeternum:quests/data/smith/smith_2
