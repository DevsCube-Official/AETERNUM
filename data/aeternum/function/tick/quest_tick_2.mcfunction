...
execute as @a[tag=aeternum.quests.enchanter_3.near_orb] if score @s aeternum.quests.enchanter_3.old_xp matches -37..-1 if score @s aeternum.abilities.enchanter.5.ability.2.cool matches 210.. run xp add @s 15 points
execute as @a[tag=aeternum.quests.enchanter_3.near_orb] run scoreboard players operation @s aeternum.quests.enchanter_3.old_xp = @s aeternum.quests.enchanter_3.current_xp
