...
execute if predicate {condition:"minecraft:time_check",value:{min:13000,max:23000}} unless entity @e[type=#taglib:hostile,distance=..25] run effect give @s invisibility
