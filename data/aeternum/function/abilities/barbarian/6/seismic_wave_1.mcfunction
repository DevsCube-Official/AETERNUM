...
execute if score @s aeternum.abilities.barbarian.6.ability.2.cool matches 1.. run return run function aeternum:abilities/deny {en:6}
...
execute at @s as @e[distance=..6] at @s run summon minecraft:creeper ~ ~ ~ {Fuse:0s,ExplosionRadius:-8b}
scoreboard players set @s aeternum.abilities.barbarian.6.ability.2.cool 200