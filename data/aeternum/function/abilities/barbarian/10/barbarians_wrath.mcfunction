...
execute if score @s aeternum.abilities.barbarian.10.ability.1.cool matches 1.. run return run function aeternum:abilities/deny {en:10}
...
effect give @s minecraft:speed 30 7 true
scoreboard players set @s aeternum.abilities.barbarian.10.ability.1.cool 400