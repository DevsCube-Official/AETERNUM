...
execute as @e[scores={aeternum.abilities.smith.1.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.1.ability.1.cool 1
execute as @a[scores={aeternum.abilities.smith.1.ability.2.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.1.ability.2.cool 1

execute as @a[scores={aeternum.abilities.smith.2.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.2.ability.1.cool 1
execute as @a[scores={aeternum.abilities.smith.2.ability.2.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.2.ability.2.cool 1

execute as @a[scores={aeternum.abilities.smith.3.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.3.ability.1.cool 1
execute as @e[scores={aeternum.abilities.smith.3.ability.2.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.3.ability.2.cool 1

execute as @a[scores={aeternum.abilities.smith.4.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.4.ability.1.cool 1
execute as @a[scores={aeternum.abilities.smith.4.ability.2.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.4.ability.2.cool 1

execute as @a[scores={aeternum.abilities.smith.5.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.5.ability.1.cool 1
execute as @a[scores={aeternum.abilities.smith.5.ability.2.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.5.ability.2.cool 1
execute as @a[scores={aeternum.abilities.smith.5.ability.3.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.5.ability.3.cool 1

execute as @a[scores={aeternum.abilities.smith.6.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.6.ability.1.cool 1
execute as @a[scores={aeternum.abilities.smith.6.ability.2.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.6.ability.2.cool 1
execute as @a[scores={aeternum.abilities.smith.6.ability.3.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.6.ability.3.cool 1

execute as @a[scores={aeternum.abilities.smith.7.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.7.ability.1.cool 1
execute as @a[scores={aeternum.abilities.smith.7.ability.2.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.7.ability.2.cool 1
execute as @a[scores={aeternum.abilities.smith.7.ability.3.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.7.ability.3.cool 1

execute as @a[scores={aeternum.abilities.smith.8.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.8.ability.1.cool 1
execute as @a[scores={aeternum.abilities.smith.8.ability.2.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.8.ability.2.cool 1
execute as @a[scores={aeternum.abilities.smith.8.ability.3.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.8.ability.3.cool 1

execute as @a[scores={aeternum.abilities.smith.9.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.9.ability.1.cool 1
execute as @a[scores={aeternum.abilities.smith.9.ability.2.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.9.ability.2.cool 1
execute as @a[scores={aeternum.abilities.smith.9.ability.3.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.9.ability.3.cool 1
execute as @a[scores={aeternum.abilities.smith.9.ability.4.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.9.ability.4.cool 1

execute as @a[scores={aeternum.abilities.smith.10.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.smith.10.ability.1.cool 1
