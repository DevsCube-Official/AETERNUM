...
summon snow_golem ~ ~ ~ {Invulnerable:1b,Tags:["aeternum.classes.summoner.summon","aeternum.classes.summoner.ice_elemental"]}
summon breeze ~ ~ ~ {Tags:["aeternum.classes.summoner.summon","aeternum.classes.summoner.breeze"]}
