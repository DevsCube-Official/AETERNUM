...
execute at @s run loot spawn ~ ~ ~ loot aeternum:class_items/swords/iron_longsword
execute at @s run loot spawn ~ ~ ~ loot aeternum:class_items/swords/golden_longsword