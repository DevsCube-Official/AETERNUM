...
# Archer
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if entity @s[tag=aeternum.abilities.archer.arrow.poison] run function aeternum:abilities/archer/6/poison_arrow_result
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if entity @s[tag=aeternum.abilities.archer.arrow.frozen] run function aeternum:abilities/archer/6/frozen_arrow_result
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if entity @s[tag=aeternum.abilities.archer.arrow.stun] run function aeternum:abilities/archer/8/stun_shot_result
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if entity @s[tag=aeternum.abilities.archer.arrow.invis] at @s run function aeternum:abilities/archer/9/camouflage_result
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if entity @s[tag=aeternum.abilities.archer.arrow.wind] at @s run function aeternum:abilities/archer/10/wind_shot_result
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if entity @s[scores={aeternum.abilities.archer.8.power_draw.cool=30..}] run function aeternum:abilities/archer/8/power_draw_result
...
# Soldier
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if score @s aeternum.abilities.soldier.1.ability.1.cool matches 170.. run function aeternum:abilities/soldier/1/bash_result {d:4,s:5}
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if score @s aeternum.abilities.soldier.2.ability.1.cool matches 170.. run function aeternum:abilities/soldier/1/bash_result {d:6,s:7}
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if score @s aeternum.abilities.soldier.4.ability.1.cool matches 170.. run function aeternum:abilities/soldier/1/bash_result {d:8,s:8}
execute as @s[type=#taglib:hostile,nbt={HurtTime:10s}] at @s on attacker if score @s aeternum.abilities.soldier.7.ability.1.cool matches 170.. run function aeternum:abilities/soldier/1/bash_result {d:10,s:9}
