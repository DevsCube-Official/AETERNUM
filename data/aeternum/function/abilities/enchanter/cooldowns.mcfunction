...
execute as @a[scores={aeternum.abilities.enchanter.2.ability.1.cool=1..}] run scoreboard players remove @s aeternum.abilities.enchanter.2.ability.1.cool 1
...
execute as @a[scores={aeternum.abilities.enchanter.6.ability.3.cool=1..}] run scoreboard players remove @s aeternum.abilities.enchanter.6.ability.3.cool 1
