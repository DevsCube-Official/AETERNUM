...
summon vex ~ ~ ~ {Silent:1b,Invulnerable:1b,CustomNameVisible:0b,PersistenceRequired:1b,CanPickUpLoot:0b,Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.enchanter.ghost"],Passengers:[{id:"minecraft:item_display",item_display:"head",Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.enchanter.ghost.display"],item:{id:"minecraft:clock",count:1,components:{"minecraft:item_model":"aeternum:general/enchanter/villager"}}}],CustomName:'"Ancient Librarian"',HandItems:[{id:"minecraft:iron_sword",count:1,components:{"minecraft:item_model":"minecraft:air"}},{}],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b,show_icon:0b,ambient:0b}]}
...
execute if score @s aeternum.abilities.enchanter.mastery matches 1.. run effect give @n[tag=aeternum.abilities.enchanter.ghost] strength infinite
