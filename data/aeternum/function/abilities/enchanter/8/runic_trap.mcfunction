...
summon item_display ~ ~ ~ {Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.enchanter.runic_trap"],item:{id:"minecraft:clock",count:1,components:{"minecraft:item_model":"aeternum:general/enchanter/runic_trap"}}}
