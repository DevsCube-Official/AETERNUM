...
execute align xyz positioned ~0.5 ~ ~0.5 run summon item_display ~ ~0.5 ~ {Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.enchanter.books_flying.book","aeternum.abilities.enchanter.books_flying.type_tome"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item_display:"head",item:{components:{"minecraft:item_model":"aeternum:general/enchanter/tome"},count:1,id:"minecraft:clock"}}
...
execute if score @s aeternum.abilities.enchanter.mastery matches 1.. run scoreboard players set @n[type=item_display,tag=aeternum.abilities.enchanter.books_flying.book] aeternum.abilities.enchanter.2.ability.1.cool 6
