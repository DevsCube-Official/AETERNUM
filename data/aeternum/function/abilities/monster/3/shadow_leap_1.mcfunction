...
execute if score @s aeternum.abilities.monster.3.ability.2.cool matches 1.. run return run function aeternum:abilities/deny {en:3}
...
execute at @s as @n[tag=!aeternum.abilities.monster.leap,distance=..5] run damage @s 6 minecraft:player_attack by @p
execute at @s run tag @s remove aeternum.abilities.monster.leap

execute at @s run scoreboard players set @s aeternum.abilities.monster.3.ability.2.cool 300
