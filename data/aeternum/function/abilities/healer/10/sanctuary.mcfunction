...
execute align xyz run summon item_display ~ ~ ~ {item_display:"fixed",Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.healer.10.sanctuary.marker"],item:{id:"minecraft:clock",count:1,components:{"minecraft:item_model":"aeternum:general/healer/circle"}}}
