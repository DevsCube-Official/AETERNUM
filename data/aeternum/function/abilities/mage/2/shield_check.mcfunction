...
execute positioned ~ ~ ~ if block ~ ~ ~ #taglib:air align xyz positioned ~0.5 ~ ~0.5 run summon marker ~ ~ ~ {Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.arcane_shield.marker"]}
execute positioned ^1 ^ ^ if block ~ ~ ~ #taglib:air align xyz positioned ~0.5 ~ ~0.5 run summon marker ~ ~ ~ {Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.arcane_shield.marker"]}
execute positioned ^-1 ^ ^ if block ~ ~ ~ #taglib:air align xyz positioned ~0.5 ~ ~0.5 run summon marker ~ ~ ~ {Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.arcane_shield.marker"]}
execute positioned ~ ~1 ~ if block ~ ~ ~ #taglib:air align xyz positioned ~0.5 ~ ~0.5 run summon marker ~ ~ ~ {Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.arcane_shield.marker"]}
execute positioned ^1 ^1 ^ if block ~ ~ ~ #taglib:air align xyz positioned ~0.5 ~ ~0.5 run summon marker ~ ~ ~ {Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.arcane_shield.marker"]}
execute positioned ^-1 ^1 ^ if block ~ ~ ~ #taglib:air align xyz positioned ~0.5 ~ ~0.5 run summon marker ~ ~ ~ {Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.arcane_shield.marker"]}
