...
execute if score @s aeternum.abilities.mage.5.fire_ball.cool matches 1.. run return run function aeternum:abilities/deny {en:5}

scoreboard players set @s aeternum.abilities.mage.5.fire_ball.cool 30
