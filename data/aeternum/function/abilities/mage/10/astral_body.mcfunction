...
execute align xyz positioned ~0.5 ~ ~0.5 run summon interaction ~ ~ ~ {width:0f,height:0f,Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.astral_marker"]}
