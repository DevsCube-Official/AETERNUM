setblock ~ ~ ~ lodestone
execute align xyz positioned ~0.5 ~ ~0.5 run summon interaction ~ ~ ~ {width:1.1f,height:1.1f,Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.recall_marker"]}
