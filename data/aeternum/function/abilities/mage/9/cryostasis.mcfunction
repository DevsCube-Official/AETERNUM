...
execute align xyz run summon block_display ~ ~ ~ {width:1.1f,height:1.1f,Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.cryostasis.display"],block_state:{Name:"minecraft:blue_ice"}}
execute align xyz run summon block_display ~ ~1 ~ {width:1.1f,height:1.1f,Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.cryostasis.display"],block_state:{Name:"minecraft:blue_ice"}}

execute align xyz positioned ~0.5 ~ ~0.5 run tp @s ~ ~ ~
playsound minecraft:entity.player.hurt_freeze player @a ~ ~ ~
execute align xyz positioned ~0.5 ~ ~0.5 run summon minecraft:interaction ~ ~ ~ {width:1.1f,height:2.1f,Tags:["aeternum.abilities.schedule.cool","aeternum.abilities.mage.cryostasis.interact"]}
