...
execute if score @s aeternum.abilities.warrior.8.ability.3.cool matches 1.. run return run function aeternum:abilities/deny {en:8}
...
execute at @s positioned ^ ^ ^6 as @e[distance=..0.99] run damage @s 5 minecraft:player_attack by @p
scoreboard players set @s aeternum.abilities.warrior.8.ability.3.cool 600